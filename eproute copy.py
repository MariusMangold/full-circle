...
# --- Konfiguration ---
PLACE = "Eppelheim, Baden-Württemberg, Germany"
FILENAME_GRAPH = "eppelheim_strassennetz.graphml"
FILENAME_ROUTE = "eppelheim_route.pkl" 
FILENAME_GPX = "eppelheim_route.gpx"
FILENAME_GEOJSON = "sperrzonen.geojson" # Deine handgezeichneten Flächen
...
def main():
    ...
    for u, v, k, data in G.edges(keys=True, data=True):
        ...
        if 'access' in data:
            ...
            if any(a in ['private', 'no', 'customers', 'delivery'] for a in access_values):
    ...
    ax.set_title(f"Every Single Street: Eppelheim (Start: {wunsch_strasse})", color="white", fontsize=14, pad=10)
    plt.show()
    ...
    plt.title("Wie oft muss jede Straße in Eppelheim gelaufen werden?", fontsize=14)
    ...
    ax.set_title("Heatmap Eppelheim | Grün: 1x | Gelb: 2x | Rot: 3x+", color="white", fontsize=14, pad=10)
    plt.show()
